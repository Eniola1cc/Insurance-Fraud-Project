...
## 8. Next Step
The next step is to convert model output probabilities into fraud risk scores and evaluate:

- fraud captured in the top 10% of claims,
- fraud captured in the top 20% of claims,
- fraud captured in the top 30% of claims.

This will show the real business value of the prioritisation system.
# Modeling Summary – Insurance Fraud Risk Prioritisation System
...
This will show the real business value of the prioritisation system.
These metric values come directly from your saved reports/model_results.csv